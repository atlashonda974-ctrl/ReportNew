...
<title>Employee Change Report</title>
                ...
                <tbody>
                    ...
                    @foreach($grouped as $transactionId => $records)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('employee.edit.exist', $first->id) }}" class="btn btn-sm btn-primary">
...
<div class="card mb-2 p-2">
    ...
    <div class="row g-2">
        ...
        <div class="col-md-3">
            ...
            <input type="text" 
                   class="form-control form-control-sm" 
                   name="employees[${index}][dependent_name]" 
                   value="${e.dependent_name ?? ''}" 
                   readonly>
        </div>
        ...
        <div class="col-md-3">
            <label>Gender</label>
            <select name="employees[${index}][gender]" 
        ...
        <div class="col-md-3">
            ...
            <input type="text" 
                   class="form-control form-control-sm" 
                   name="employees[${index}][employee_code]" 
        ...
        <div class="col-md-3">
            ...
            <input type="date" 
                   class="form-control form-control-sm" 
                   name="employees[${index}][effective_date]" 
                   value="${e.effective_date ? new Date(e.effective_date).toISOString().split('T')[0] : ''}" 
                   readonly>
        </div>
