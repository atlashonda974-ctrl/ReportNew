...
<div class="container mt-5">
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form action="{{ route('employee.update.change', $record->id) }}" method="POST">
                @csrf
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="client_name" class="form-control"
                               value="{{ $record->client_name }}" required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="policy_no" class="form-control"
                               value="{{ $record->policy_no }}">
                    </div>
                </div>

                <!-- Buttons -->
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('employee.view') }}" class="btn btn-secondary">
