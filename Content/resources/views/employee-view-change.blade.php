                ...
                <tbody>
                    ...
                    @foreach($grouped as $transactionId => $records)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('employee.edit.change', $first->id) }}" class="btn btn-sm btn-primary">
...
<div class="card mb-2 p-2">
    ...
    <div class="row g-2">
        ...
        <div class="col-md-3">
            <label>Existing Details</label>
            <input type="text" class="form-control form-control-sm" name="employees[${index}][existing_details]" value="${e.existing_details ?? ''}" readonly>
        </div>
        <div class="col-md-3">
