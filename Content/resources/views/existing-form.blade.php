...
<head>
    ...
    <title>For Existing Employee</title>
...
<div class="container mt-5 mb-5">
    ...
    <div class="card shadow">
        <div class="card-header text-center bg-primary text-white p-3">
            <h4 class="mb-0">For Existing Employee</h4>
        </div>
        ...
        <div class="card-body p-0">
            ...
            <!-- Dynamic Form Table -->
            <form id="employee-addition-form" action="{{ route('employee.store.exist') }}" method="POST">
                @csrf 
                    ...
                    <table class="table table-bordered table-sm mb-0" id="employee-table">
                        <thead class="table-light" style="white-space: nowrap;">
                            <tr>
                                ...
                                <th style="width: 9%;">Dependent Name </th>
    ...
    function addEmployeeRow() {
        ...
        const newRow = `
            <tr>
                ...
                <td><input type="text" name="employees[${index}][dependent_name]" class="form-control form-control-sm"></td>
                 <td>
