...
<head>
    ...
    <title>New Addition of Employee</title>
...
<div class="container mt-5 mb-5">
    ...
    <div class="card shadow">
        <div class="card-header text-center bg-primary text-white p-3">
            <h4 class="mb-0">For New Addition of Employee</h4>
        </div>
        ...
        <div class="card-body p-0">
            ...
            <!-- Dynamic Form Table -->
            <form id="employee-addition-form" action="{{ route('employee.add.store') }}" method="POST">
                @csrf 
                    ...
                    <table class="table table-bordered table-sm mb-0" id="employee-table">
                        <thead class="table-light" style="white-space: nowrap;">
                            <tr>
                                ...
                                <th style="width: 10%;">DOB/ Age</th>
                                <th style="width: 14%;">CNIC No</th>
                                <th style="width: 10%;">Relation</th>
                                <th style="width: 12%;">Effective Date of Addition</th>
    ...
    function addEmployeeRow() {
        ...
        const newRow = `
            <tr>
                ...
                <td><input type="text" name="employees[${index}][employee_id]" class="form-control form-control-sm"></td>
                <td><input type="text" name="employees[${index}][plan]" class="form-control form-control-sm"></td>
                <td><input type="date" name="employees[${index}][dob]" class="form-control form-control-sm"></td>
                <td><input type="text" name="employees[${index}][cnic]" class="form-control form-control-sm" placeholder="XXXXX-XXXXXXX-X"></td>
                <td><input type="text" name="employees[${index}][relation]" class="form-control form-control-sm"></td>
                <td><input type="date" name="employees[${index}][effective_date]" class="form-control form-control-sm" required></td>
