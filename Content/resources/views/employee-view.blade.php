...
<div class="container mt-5">
    <h3 class="mb-4">Employee Report</h3>
                ...
                <tbody>
                    ...
                    @foreach($grouped as $transactionId => $records)
                        ...
                        <tr>
                            ...
                            <td>{{ $first->effective_date ? \Carbon\Carbon::parse($first->effective_date)->format('d-m-Y') : '-' }}</td>
                            <td>
                            ...
                            <td>
                                <a href="{{ route('employee.edit', $first->id) }}" class="btn btn-sm btn-primary">
...
<div class="card mb-2 p-2">
    ...
    <div class="row g-2">
        <div class="col-md-4"><label>Name</label><input type="text" class="form-control form-control-sm" value="${e.employee_name ?? ''}" required></div>
        <div class="col-md-2"><label>Gender</label><input type="text" class="form-control form-control-sm" value="${e.gender ?? ''}" readonly></div>
        <div class="col-md-3"><label>Employee ID</label><input type="text" class="form-control form-control-sm" value="${e.employee_id ?? ''}"></div>
        <div class="col-md-3"><label>Plan</label><input type="text" class="form-control form-control-sm" value="${e.plan ?? ''}"></div>
        <div class="col-md-3"><label>DOB</label><input type="date" class="form-control form-control-sm" value="${e.dob ? moment(e.dob).format('YYYY-MM-DD') : ''}"></div>
        <div class="col-md-3"><label>CNIC</label><input type="text" class="form-control form-control-sm" value="${e.cnic_no ?? ''}" placeholder="XXXXX-XXXXXXX-X"></div>
        <div class="col-md-3"><label>Relation</label><input type="text" class="form-control form-control-sm" value="${e.relation ?? ''}"></div>
        <div class="col-md-3"><label>Effective Date</label><input type="date" class="form-control form-control-sm" value="${e.effective_date ? moment(e.effective_date).format('YYYY-MM-DD') : ''}" required></div>
    </div>
</div>`;
        });
